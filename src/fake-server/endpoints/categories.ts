...
export function getCategories($http: HttpClient, options?: GetCategoriesOptions): Observable<ShopCategory[]> {
    return $http.get<ShopCategory[]>('https://localhost:5001/api/products/popularcategories');
    /*
